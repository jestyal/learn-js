...
document.addEventListener("DOMContentLoaded", (event) => {
    localComicsCharacters.forEach((character, index) => {
        console.log(character, index);
        createElement(character, index);
    })
...
function createElement(value, index) {
    ...
    ratingLabel.setAttribute("for", "range-" + index);
    ...
    rangeInput.setAttribute("id", "range-" + index);
    rangeInput.setAttribute("step", "1");
    rangeInput.setAttribute("min", "1");
    rangeInput.setAttribute("max", "10");
    rangeInput.setAttribute("value", value.rating);
    rangeBlock.append(rangeInput);


    if(value.rating !== ""){
        let userRatingBlock = document.createElement("span");
        userRatingBlock.classList.add("rating__value");
        userRatingBlock.innerText = value.rating;
